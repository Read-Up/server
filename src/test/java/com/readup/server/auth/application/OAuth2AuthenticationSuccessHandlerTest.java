...
class OAuth2AuthenticationSuccessHandlerTest {
	...
	@Test
	@DisplayName("인증 성공 시 쿠키와 함께 리다이렉트 - 세션 null")
	void testHandleAuthenticationSuccess_session_null() throws ServletException, IOException {
	...
	@Test
	@DisplayName("인증 성공 시 쿠키와 함께 리다이렉트 - URI null")
	void testHandleAuthenticationSuccess_redirect_null() throws ServletException, IOException {
	...
	@Test
	@DisplayName("인증 성공 시 쿠키와 함께 리다이렉트 URI not null")
	void testHandleAuthenticationSuccess_redirect_notNull() throws ServletException, IOException {
